...
// Fungsi login
Given('Login B2B berhasil - 008', { timeout: 1555000 }, async function () {
...
// Isi data tag baru
When('Mengisi semua data ,Pada Tag Color di iisi kosong - 008', { timeout: 1555000 }, async function () {
  ...
  // await this.page.locator('div:nth-child(2) > div > .col-lg-9 > .form-control').first().fill('');
...
Then('Klik Save, data tidak berhasil disimpan - 008', { timeout: 1555000 }, async function () {
  try {
