...
// Fungsi login
Given('Login B2B berhasil (007)', { timeout: 1555000 }, async function () {
...
// Isi data tag baru
When('Mengisi semua data ,Pada Tag Name diisi dengan data yang tersave sebelumnya (007)', { timeout: 1555000 }, async function () {
  ...
  await this.page.getByRole('textbox').first().fill('PLAYWRIGHT_TEST');
...
Then('Klik Save, data tidak berhasil disimpan (007)', { timeout: 1555000 }, async function () {
  try {
