...
// Fungsi login
Given('Login B2B berhasil (005)', { timeout: 1555000 }, async function () {
...
// Isi data tag baru
When('Mengisi semua data,Pada Tag Name diisi dengan karakter spesial (005)', { timeout: 1555000 }, async function () {
...
Then('Klik Save, data tidak berhasil disimpan (005)', { timeout: 1555000 }, async function () {
  try {
