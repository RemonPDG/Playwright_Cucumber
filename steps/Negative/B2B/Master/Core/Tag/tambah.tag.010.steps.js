...
const randomString2 = generateRandomString(500); // Panjang 10 karakter
...
// Fungsi login
Given('Login B2B berhasil (010)', { timeout: 1555000 }, async function () {
...
// Isi data tag baru
When('Mengisi semua Data, Pada Remarks diisi dengan 500 karakter (010)', { timeout: 1555000 }, async function () {
  ...
  await this.page.locator('textarea').fill(randomString2);
...
Then('Klik Save, data tidak berhasil disimpan (010)', { timeout: 1555000 }, async function () {
  try {
