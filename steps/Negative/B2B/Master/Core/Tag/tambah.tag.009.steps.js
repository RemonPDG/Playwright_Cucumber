...
// Fungsi login
Given('Login B2B berhasil (009)', { timeout: 1555000 }, async function () {
...
// Isi data tag baru
When('Mengisi semua data ,Pada Tag Color diisi dengan warna yang tidak valid (009)', { timeout: 1555000 }, async function () {
  ...
  await this.page.locator('div:nth-child(2) > div > .col-lg-9 > .form-control').first().fill('#GGG000');

});
console.log(randomString);

// Klik Save dan verifikasi hasil
Then('Klik Save, data tidak berhasil disimpan (009)', { timeout: 1555000 }, async function () {
  try {
