...
const randomString = generateRandomString(300); // Panjang 10 karakter
...
// Fungsi login
Given('Login B2B berhasil - 003', { timeout: 1555000 }, async function () {
...
// Isi data tag baru
When('Mengisi semua data ,Pada Tag Name diisi 300 karakter - 003', { timeout: 1555000 }, async function () {
...
Then('Klik Save, data tidak berhasil disimpan - 003', { timeout: 1555000 }, async function () {
  try {
